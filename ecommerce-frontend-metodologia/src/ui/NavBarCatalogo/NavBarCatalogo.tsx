...
export const NavBarCatalogo = () => {
  return (
    <div className={styles.containerNavBarCatalogo}>
        ...
        <input type='text'placeholder='busque un producto' className={styles.barraBusquedaCatalogo}></input>
        <Search className={styles.searchIconCalogo} color='black' size={20} />
        <div className={styles.iconShoppinCartCatalogo}><ShoppingCart color='black' size={40} /></div>
    </div>
  )
}
