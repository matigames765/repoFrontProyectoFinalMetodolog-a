...
export const crearDetalleProducto = async (
  detalleProducto: IDetalleProductos
) => {
  try {
    const response = await axios.post<IDetalleProductos>(
      "http://localhost:9000/detalleProducto",
      { detalleProducto }
    );
...
export const editarDetalleProducto = async (
  detalleProductoActualizado: IDetalleProductos
) => {
  try {
    const response = await axios.put<IDetalleProductos>(
      "http://localhost:9000/detalleProducto",
      { detalleProductoActualizado }
    );
