...
export const ColumnFilterCatalogo = () => {
  ...
  const setOrdenPrecioActivo = filterStore(
    (state) => state.setOrdenPrecioActivo
  );
    ...
    <div className={styles.principalContainerColumFilter}>
      ...
      >
        ...
        <select
          ...
          value={talleActivo ?? ""}
          onChange={(e) => {
            if (e.target.value === "deseleccionar") setTalleActivo("");
            else setTalleActivo(e.target.value);
          }}
        >
        ...
        <select
          ...
          onChange={(e) => {
            if (e.target.value === "deseleccionar") setOrdenPrecioActivo("");
            else setOrdenPrecioActivo(e.target.value);
          }}
        >
          <option value="" disabled hidden>
            Ordenar por precio
